...
public:
	CMainParams() {
		...
		const char* pszTimestamp = "18 Feb 2018 The Birthday of Apollon Masternode Coin";
		...
		vout.resize(1);
		vout[0].SetEmpty();
		CTransaction txNew(1, 1518720873, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
		genesis.nTime = 1518720873;
		genesis.nBits = 520159231;
		genesis.nNonce = 4657969;
    ...
    // std::cout << hashGenesisBlock.ToString() << std::endl;
		...
		assert(genesis.hashMerkleRoot == uint256("0xf6bfee4f9e467cf01a09cb42a957ba134f3f5d8969610eae81c956ce4f7e614f"));
		assert(hashGenesisBlock == uint256("0x87c2ad76968b2f84464a7dc10e34e7840e00872c3faf0087d587a1dd85d27808"));
